...
{
	if (this->guard_mode)
		std::cout << this->name << " activated Guard Mode" << std::endl;
	else
		std::cout << this->name << " not activated Guard Mode" << std::endl;
}

void	ScavTrap::takeDamage(unsigned int amount)
{
	if (this->guard_mode)
		std::cout << this->name << "'s Guard Mode active don't take any damage" << std::endl;
	else
